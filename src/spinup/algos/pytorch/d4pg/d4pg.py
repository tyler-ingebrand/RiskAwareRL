...
import gym
import time
import spinup.algos.pytorch.d4pg.core as core
from spinup.utils.logx import EpochLogger

class ReplayBuffer:
    """
    A simple FIFO experience replay buffer for d4pg agents.
    """
...
def d4pg(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    # Set up function for computing d4pg Q-loss
    ...
    # Set up function for computing d4pg pi loss
    def compute_loss_pi(data):
        o = data['obs']
        q_raw = ac.q(o, ac.pi(o))
    ...
    def update(data):
        ...
        # Unfreeze Q-network so you can optimize it at next d4pg step.
        for p in ac.q.parameters():
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='d4pg')
    args = parser.parse_args()

    from spinup.utils.run_utils import setup_logger_kwargs
    logger_kwargs = setup_logger_kwargs(args.exp_name, args.seed)

    d4pg(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
