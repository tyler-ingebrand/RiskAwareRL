...
def run_policy(logger, env, get_action, model, epsilon=0.01,
               max_ep_len=None, num_episodes=100):
...
if __name__ == '__main__':
    ...
    f = open('results/' + args.task + '_state.txt', "w")
    ...
    for k in range(len(algos)):
        ...
        for i in range(10):
            seed = str(i)
            fpath = "src/data/{}/{}/seed{}/{}/{}/seed{}_s{}".format(args.task, algo, seed, args.task, algo, seed, seed)
