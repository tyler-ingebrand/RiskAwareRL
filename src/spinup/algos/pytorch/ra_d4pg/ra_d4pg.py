...
import gym
import time
import spinup.algos.pytorch.ra_d4pg.core as core
...
def ra_d4pg(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
...
if __name__ == '__main__':
    ...
    ra_d4pg(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
